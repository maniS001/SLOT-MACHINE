...
export async function LoadPreloadAssets() {
  Assets.addBundle("preload-assets", {
    ...
    Loading_bar_empty_1:
      "./public/assets/loading-screen/Loading_bar_empty_1.png",
...
export async function LoadGameAssets() {
  const GameBundle_common = {
    // animations
    BaseGame_BG_atlas:
      "./public/assets/Animations/background/BaseGame_BG.atlas",
    ...
    Cash_Value_regular_json:
      "./public/assets/Animations/symbols/Cash_Value_regular.json",
    Cash_Value_regular_atlas:
      "./public/assets/Animations/symbols/Cash_Value_regular.atlas",
    ...
    Scatter_Regular_json:
      "./public/assets/Animations/symbols/Scatter_Regular.json",
    Scatter_Regular_atlas:
      "./public/assets/Animations/symbols/Scatter_Regular.atlas",
